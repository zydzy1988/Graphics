...
namespace UnityEditor.Rendering.HighDefinition
{
    internal class SurfaceOptionUIBlock : MaterialUIBlock
    {
        ...
        internal static class Styles
        {
            ...
            // SSR
            public static GUIContent receivesSSRText = new GUIContent("Receive SSR/Receive SSGI", "When enabled, this Material can receive screen space reflections and screen space global illumination.");
