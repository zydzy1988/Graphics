...
namespace UnityEditor.Rendering.Universal
{
    ...
    [MovedFrom("UnityEditor.Rendering.LWRP")] public class ForwardRendererDataEditor : ScriptableRendererDataEditor
    {
        private static class Styles
        {
            ...
            public static readonly GUIContent TransparentAfterPostProcessingLayerMask = new GUIContent("After Post Processing Transparent Layer Mask");
        ...
        SerializedProperty m_TransparentAfterPostProcessingLayerMask;
        ...
        private void OnEnable()
        {
            ...
            m_TransparentAfterPostProcessingLayerMask = serializedObject.FindProperty("m_TransparentAfterPostProcessingLayerMask");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_TransparentAfterPostProcessingLayerMask, Styles.TransparentAfterPostProcessingLayerMask);
            EditorGUI.indentLevel--;
            EditorGUILayout.Space();
