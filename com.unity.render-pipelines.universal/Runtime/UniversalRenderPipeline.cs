...
#pragma warning restore
        ...
        static void RenderSingleCamera(ScriptableRenderContext context, CameraData cameraData, bool anyPostProcessingEnabled)
        {
            ...
            using (new ProfilingScope(cmd, sampler))
            {
                ...
                {
                    InitializeRenderingDataForUICamera(asset, ref cameraData, ref cullResults);
        ...
        static void InitializeAdditionalCameraData(Camera camera, UniversalAdditionalCameraData additionalCameraData, bool resolveFinalTarget, ref CameraData cameraData)
        {
            ...
            if (isOverlayCamera || cameraData.renderType == CameraRenderType.UI)
            {
...
#pragma warning restore
        ...
        static void SetupPerFrameShaderConstants()
        {
            ...
            Shader.SetGlobalVector(PerFrameBuffer._AmbientColor, RenderSettings.ambientLight.linear);
